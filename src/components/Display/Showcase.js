    ...
    return (
        <div  style={bg}  className='bg'>
            ...
            <div className='col-md-6  text-white font-1'>
                ...
                <p>So irrespective of profession, get on board now and show us what you do. It wont't cost you a dime. Be it hair dressing, baking , photography, cooking etc or you just want to advertise yourself as available to work.</p>
            ...
            Do not send money if you cannot verify the identity or meet the service provider in person as we would not be held responsible for any fraudulent activities. Thank you.
                </span>
            </div>
            </div>
            </div>
